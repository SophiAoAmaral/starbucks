...
function NavBar(){
    return (
      <header className="text-capitalize flex font-primary uppercase font-bold w-full justify-around mb-5 px-25 py-3  bg-white  fixed  top-0">
              ...
              <div className="flex items-center ">
                  ...
                  <div className="flex">
                    ...
                    <Link to='/NossoCafe' className="py-3 px-2 ml-1 text-sm hover:text-green-800 relative right-10">
                    Nosso Café
                    </Link>

                    <Link to='/impacto' className="py-3 px-2 ml-1 text-sm hover:text-green-800 relative right-10">
                    Impacto Social
                    </Link>
                  </div>
              </div>
              <div className="flex items-center">
                ...
                <a href="https://historias.starbucks.com/br/" target="_blank"><img src="../public/img/history.png" alt="" className="mr-4 w-35 cursor-pointer hidden md:block"/></a>
